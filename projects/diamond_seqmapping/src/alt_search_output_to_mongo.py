...
collection = db["custom_search_14_replaced_taxid"]

script_dir = os.path.dirname(os.path.abspath(__file__))
parent_dir = os.path.dirname(script_dir)
outf_path = os.path.join(parent_dir, "output", "custom_search_14_replaced_taxid.tsv")
logf_path = os.path.join(parent_dir, "log", "log_writeToMongo_replaced_taxid.txt")
